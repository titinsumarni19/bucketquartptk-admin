...
class ProdukController extends Controller
{
    public function index()
    {
        ...
        $client = new Client();
        $url = '103.175.217.148/produk/getallproduk';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = Http::attach('image', file_get_contents($imagePath), $imageName)
                ->post('103.175.217.148/produk/create', [
    ...
    public function editProduk($id) {
        $client =new Client();
        $response = $client->request('GET', '103.175.217.148/produk/getprodukbyid/' . $id);
    ...
    public function hapusProduk($id)
    {
        try {
            ...
            $response = Http::delete('103.175.217.148/produk/delete/' . $id);
    ...
    public function updateProduk(Request $request, $id)
    {
        ...
        $client = new Client();
        $url = '103.175.217.148/produk/edit/' . $id;
