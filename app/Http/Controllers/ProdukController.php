...
class ProdukController extends Controller
{
    public function index()
    {
        ...
        $client = new Client();
        $url = 'http://127.0.0.1:5001/produk/getallproduk';
    ...
    {
        $client = new Client();
        $url = 'http://127.0.0.1:5001/kategori/getallkategori';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = Http::attach('image', file_get_contents($imagePath), $imageName)
                ->post('http://127.0.0.1:5001/produk/create', [
    ...
    public function editProduk($id) {
        $client =new Client();
        $response = $client->request('GET', 'http://127.0.0.1:5001/produk/getprodukbyid/' . $id);
    ...
    public function hapusProduk($id)
    {
        try {
            ...
            $response = Http::delete('http://127.0.0.1:5001/produk/delete/' . $id);
    ...
    public function updateProduk(Request $request, $id)
    {
        ...
        $client = new Client();
        $url = 'http://127.0.0.1:5001/produk/edit/' . $id;
