...
class KategoriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $response = Http::post('http://127.0.0.1:5001/kategori/create', [
    ...
    public function editKategori($id) {
        $client =new Client();
        $response = $client->request('GET', 'http://127.0.0.1:5001/kategori/getkategoribyid/' . $id);
    ...
    public function hapusKategori($id)
    {
        try {
            ...
            $response = Http::delete('http://127.0.0.1:5001/kategori/delete/' . $id);
    ...
    public function updateKategori(Request $request, $id)
    {
        ...
        try {
            $client = new Client();
            $url = 'http://127.0.0.1:5001/kategori/edit/' . $id;
