...
class TransaksiController extends Controller
{
    ...
    {
        $client =new Client();
        $url = 'http://103.175.217.148:5002/transaksi/gettransaksibyid/' . $id;
    ...
    public function hapusTransaksi($id)
    {
        try {
            ...
            $response = Http::delete('http://103.175.217.148:5002/transaksi/delete/' . $id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $client = new Client();
            $url = 'http://103.175.217.148:5002/transaksi/update/' . $id;
